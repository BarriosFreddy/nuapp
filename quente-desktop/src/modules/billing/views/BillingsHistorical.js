...
import BillingTemplateHTML from './print-templates/BillingTemplateHTML'
...
function BillingsHistorical() {
  ...
  const billingData = {
    createdAt: { date: 1699815200929, offset: -18000000 },
    receivedAmount: 30000,
    billAmount: 28000,
    items: [
      {
        _id: '64c6fcaa088e93396e88ce2c',
        name: 'DOLEX BEBE',
        code: '7441026003348',
        price: 23000,
        units: 1,
      ...
      {
        _id: '64d4cf8fa51ef1cb12128503',
        name: 'ACETAMINOFEN 90ML',
        code: '7703038065630',
        price: 5000,
        units: 1,
        measurementUnit: 'JARABE',
        multiplicity: 1,
      },
    ],
        ...
        <CCard className="shadow border-10">
          ...
          <CCardBody>
            <CContainer className="mt--6" fluid>
              ...
              {/*  <BillingTemplateHTML billing={billingData} /> */}
            </CContainer>
          </CCardBody>
        </CCard>
      </CContainer>
