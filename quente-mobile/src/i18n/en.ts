const en = {
  ...
  requests: {
    loadingText: 'Loading ride requets',
    details: {
      title: 'Ride request',
  ...
  welcomeScreen: {
    postscript:
      "psst  — Hiiiiii.....This probably isn't what your app looks like. (Unless your designer handed you these screens, and in that case, ship it!)",
