...
itemRouter.get('/code/:code', authenticate_middleware_1.default, (0, role_validation_middleware_1.roleValidation)((0, util_1.generateAuthKeyPair)(modules_codes_1.ModuleCode.BILLING, privileges_1.Privilege.ACCESS)), item_controller_1.default.existByCode);
itemRouter.get('/name/:name', authenticate_middleware_1.default, (0, role_validation_middleware_1.roleValidation)((0, util_1.generateAuthKeyPair)(modules_codes_1.ModuleCode.BILLING, privileges_1.Privilege.ACCESS)), item_controller_1.default.existByName);
