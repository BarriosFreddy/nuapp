...
export class Config {
  ...
  'jhipster.mail.from' = 'nuapp@localhost';
  'jhipster.swagger.default-include-pattern' = '/api/.*';
  'jhipster.swagger.title' = 'nuapp API';
  'jhipster.swagger.description' = 'nuapp API documentation';
  ...
  'eureka.instance.appname' = 'nuapp';
  'eureka.instance.instanceId' = 'nuapp:${random.value}';
  ...
  'eureka.client.service-url.defaultZone' =
    'http://admin:${jhipster.registry.password}@localhost:8761/eureka/';
  'cloud.config.uri' =
    'http://admin:${jhipster.registry.password}@localhost:8761/config';
  'cloud.config.name' = 'nuapp';
